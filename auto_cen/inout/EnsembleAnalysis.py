...
class EnsembleAnalysis:
    ...
    def _create_evaluation_table(self, cmb_metrics, bc_metrics,
        ...
        header = ["Algorithm", "Encoder", "Noise Filter", "Feature Sel.", "Dim. Red.", "Over Samp.",
                  "Under Samp.", *cmb_metrics.keys()]
    ...
    def _reoptimize_ensemble(self, budget: int, data: DataStore, models: list, config_space: list,
        ...
        """
        cs = create_cs(config_space, ens_size=len(self.base_classifier))
